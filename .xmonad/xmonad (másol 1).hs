...
myLayoutHook = spacingRaw True (Border 0 5 5 5) True (Border 5 5 5 5) True $ gaps [(U,45), (D,10), (R,10), (L,10)]
               $ avoidStruts
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask .|. shiftMask , xK_d ), spawn $ "dmenu_run -i -nb '#191919' -nf '#5e81ac' -sb '#5e81ac' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=22'")
